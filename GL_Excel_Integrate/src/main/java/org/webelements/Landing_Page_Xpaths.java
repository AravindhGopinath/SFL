...
public class Landing_Page_Xpaths extends BaseClass {
    ...
    @FindBy(xpath="(//h4[@class='rdCalcOutput'])[7]")
    
    private WebElement loanamount_slider_value;

    @FindBy(xpath="(//div[@class='noUi-touch-area'])[7]")

    private WebElement loanamount_slider;
    
    @FindBy(xpath="(//h4[@class='rdCalcOutput'])[8]")
    
    private WebElement annualized_rate_of_ineterest_slider_value;
    ...
    @FindBy(xpath="(//h4[@class='rdCalcOutput'])[9]")
    
    private WebElement loan_tenure_slider_value;

    public WebElement getLoanamount_slider_value() {
		return loanamount_slider_value;
	}

	public WebElement getAnnualized_rate_of_ineterest_slider_value() {
		return annualized_rate_of_ineterest_slider_value;
	}

	public WebElement getLoan_tenure_slider_value() {
		return loan_tenure_slider_value;
	}
