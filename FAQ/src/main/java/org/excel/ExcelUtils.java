...
public class ExcelUtils {
    ...
    public static ArrayList<Object[]> getDataFromexcel() {
        ...
        try {
            String Excel_Name="D:\\Automation Reports\\Articles_Brokenlink_06-01-2023 -Live.xlsx";
    ...
    public static void writeinexcel(String value, int INDEX) throws Exception {
        Thread.sleep(2000);
        File fis = new File("D:\\Automation Reports\\Articles_Brokenlink_06-01-2023 -Live.xlsx");
